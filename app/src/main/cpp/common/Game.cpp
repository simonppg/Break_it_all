...
void Game::camera_forward() {
  ...
  camera->move(cameraPosition.decrementZ(1));
}

void Game::camera_back() {
  Point3D cameraPosition = camera->getPosition();
  camera->move(cameraPosition.incrementZ(1));
}

void Game::camera_left() {
  Point3D cameraPosition = camera->getPosition();
  camera->move(cameraPosition.decrementX(1));
}

void Game::camera_right() {
  Point3D cameraPosition = camera->getPosition();
  camera->move(cameraPosition.incrementX(1));
}
...
void Game::camera_reset() { camera->move(Point3D()); }
