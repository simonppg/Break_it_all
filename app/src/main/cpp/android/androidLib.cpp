...
JNIEXPORT void JNICALL Java_com_example_game_jni_BreakItAll_surfaceCreated
...
JNIEXPORT void JNICALL Java_com_example_game_jni_BreakItAll_drawFrame
        (JNIEnv * env, jclass cls) {
    // game->update();
    game->render();
}
...
JNIEXPORT jobjectArray JNICALL Java_com_example_game_jni_BreakItAll_getTestsList
        (JNIEnv * env, jclass cls) {
    jstring str;
...
Java_com_example_game_jni_BreakItAll_init(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
Java_com_example_game_jni_BreakItAll_pause(JNIEnv *env, jclass type) {
    game->pause();
    delete game;
    game = nullptr;
}
...
JNIEXPORT void JNICALL
Java_com_example_game_jni_BreakItAll_stop(JNIEnv *env, jclass type) {
    delete game;
}
