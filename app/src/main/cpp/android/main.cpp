...
JNIEXPORT void JNICALL Java_com_example_game_jni_GameLibJNIWrapper_surfaceCreated
        (JNIEnv * env, jclass cls) {
    game->surfaceCreated();
}

JNIEXPORT void JNICALL Java_com_example_game_jni_GameLibJNIWrapper_surfaceChanged
        (JNIEnv * env, jclass cls, jint width, jint height) {
    game->surfaceChanged(width, height);
}

JNIEXPORT void JNICALL Java_com_example_game_jni_GameLibJNIWrapper_drawFrame
        (JNIEnv * env, jclass cls) {
    game->update();
    game->render();
}

JNIEXPORT bool JNICALL Java_com_example_game_jni_GameLibJNIWrapper_on_1touch_1event
...
JNIEXPORT jobjectArray JNICALL Java_com_example_game_jni_GameLibJNIWrapper_getTestsList
        (JNIEnv * env, jclass cls) {
#define LEN 5
...
Java_com_example_game_jni_GameLibJNIWrapper_init(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
Java_com_example_game_jni_GameLibJNIWrapper_pause(JNIEnv *env, jclass type) {
    game->pause();
    delete game;
    game = nullptr;
}
...
JNIEXPORT void JNICALL
Java_com_example_game_jni_GameLibJNIWrapper_resume(JNIEnv *env, jclass type) {
    game->resume();
}

JNIEXPORT void JNICALL
Java_com_example_game_jni_GameLibJNIWrapper_stop(JNIEnv *env, jclass type) {
    delete game;
}
