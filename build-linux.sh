...
mkdir -pv $BUILD_DIR && cd $BUILD_DIR && cmake .. -DCMD_ARGS="5" -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DCMAKE_CXX_FLAGS="-isystem /usr/include/c++/11/ -isystem /usr/include/x86_64-linux-gnu/c++/11/" && make run
